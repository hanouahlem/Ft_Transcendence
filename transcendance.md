...
<table>
    ...
    <tr>
        <td></td>
        <td>II.1 Team Organization and Project Management</td>
        <td>4</td>
    </tr>
    <tr>
        <td></td>
        <td>II.1.1 Required Team Roles</td>
        <td>4</td>
    </tr>
    <tr>
        <td></td>
        <td>II.1.2 Recommended Project Management Practices</td>
        <td>5</td>
    </tr>
    <tr>
        <td>**III**</td>
    ...
    <tr>
        <td></td>
        <td>III.1 What are we doing?</td>
        <td>7</td>
    </tr>
    <tr>
        <td></td>
        <td>III.2 General requirements</td>
        <td>8</td>
    </tr>
    <tr>
        <td></td>
        <td>III.3 Technical requirements</td>
        <td>9</td>
    </tr>
    <tr>
        <td>**IV**</td>
    ...
    <tr>
        <td></td>
        <td>IV.2 Accessibility and Internationalization</td>
        <td>13</td>
    </tr>
    <tr>
        <td></td>
        <td>IV.3 User Management</td>
        <td>14</td>
    </tr>
    <tr>
        <td></td>
        <td>IV.4 Artificial Intelligence</td>
        <td>15</td>
    </tr>
    <tr>
        <td></td>
        <td>IV.5 Cybersecurity</td>
        <td>16</td>
    </tr>
    <tr>
        <td></td>
        <td>IV.6 Gaming and user experience</td>
        <td>16</td>
    </tr>
    <tr>
        <td></td>
    ...
    <tr>
        <td></td>
        <td>IV.8 Data and Analytics</td>
        <td>19</td>
    </tr>
    <tr>
        <td></td>
        <td>IV.9 Blockchain</td>
        <td>20</td>
    </tr>
    <tr>
        <td></td>
        <td>IV.10 Modules of choice</td>
        <td>20</td>
    </tr>
    <tr>
        <td>**V**</td>
        <td>**Project Ideas and Examples**</td>
        <td>**21**</td>
    </tr>
    <tr>
        <td></td>
        <td>V.1 Example: Building a Pong Game</td>
        <td>21</td>
    </tr>
    <tr>
        <td></td>
        <td>V.2 Gaming Projects</td>
        <td>21</td>
    </tr>
    <tr>
        <td></td>
        <td>V.3 Social and Collaborative Projects</td>
        <td>22</td>
    </tr>
    <tr>
        <td></td>
        <td>V.4 Creative and Media Projects</td>
        <td>23</td>
    </tr>
    <tr>
        <td></td>
        <td>V.5 Productivity and Tools Projects</td>
        <td>24</td>
    </tr>
    <tr>
        <td></td>
        <td>V.6 Specialized Projects</td>
        <td>25</td>
    </tr>
    <tr>
        <td>**VI**</td>
        <td>**Readme Requirements**</td>
        <td>**27**</td>
    </tr>
    <tr>
        <td>**VII**</td>
    ...
    <tr>
        <td>**VIII**</td>
        <td>**Submission and peer-evaluation**</td>
        <td>**31**</td>
    </tr>
</table>
...
> <mark>⚠️ This is a long group project. Poor early choices and lack of team coordination will cost a lot of time. Your project and team management will strongly impact your results. All team members must actively participate and contribute to both the mandatory part and the modules.</mark>
...
> <mark>**Project Examples:** Your project can take many forms. Here are some valid examples:
...
> 
> The key is to create something engaging that demonstrates your technical skills and creativity.</mark>
...
> <mark>⚠️ **Privacy Policy and Terms of Service:** These pages will be verified during evaluation. They must:</mark>
> *   <mark>Be easily accessible from the application (e.g., footer links).</mark>
> *   <mark>Contain relevant and appropriate content for your project.</mark>
> *   <mark>Not be placeholder or empty pages.</mark>
>
> <mark>Missing or inadequate Privacy Policy/Terms of Service pages will result in project rejection.</mark>

> <mark>⚠️ **Multi-user Support (Mandatory):** Your website must support multiple users simultaneously. This is a core requirement of the project. Users should be able to interact with the application at the same time without conflicts or performance issues. This includes:</mark>
> *   <mark>Multiple users can be logged in and active at the same time.</mark>
> *   <mark>Concurrent actions by different users are handled properly.</mark>
> *   <mark>Real-time updates are reflected across all connected users when applicable.</mark>
> *   <mark>No data corruption or race conditions occur with simultaneous user actions.</mark>
...
> <mark>This module requires you to have implemented at least one game (see "Gaming and user experience" section). You cannot claim this module without a functional game.</mark>
...
> <mark>This module requires you to have implemented at least one game (see "Gaming and user experience" section). The AI must be able to play your game competently.</mark>
...
> <mark>This module requires you to have implemented at least one game (see "Gaming and user experience" section). You're extending your game to support three or more players.</mark>
...
> <mark>This module requires you to have already implemented a first game (see "Implement a complete web-based game" module above). You cannot claim this module without having a functional first game.</mark>
...
> <mark>This module enhances the basic chat system from the "Allow users to interact" module. You cannot claim this module without having implemented the basic chat first.</mark>
...
> <mark>This module requires you to have implemented at least one game (see "Gaming and user experience" section). You cannot have tournaments without a game to play.</mark>
...
> <mark>This module requires you to have implemented at least one game (see "Gaming and user experience" section). You're adding customization to an existing game.</mark>
...
> <mark>While this is a Minor module (1 point), implementing a complete gamification system can be substantial. Focus on quality over quantity—three well-implemented features are better than six poorly done ones.</mark>
...
> <mark>This module requires you to have implemented at least one game (see "Gaming and user experience" section). Spectators need a game to watch.</mark>
...
<mark>This is just one example. You can mix and match modules from different categories to create your own unique project. The key is to ensure that your modules work together coherently and add value to your application.</mark>
...
<mark>
⚠️ These are just ideas to inspire you. The key is to choose a project that:
