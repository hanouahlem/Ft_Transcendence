...
import { Bell, House, Leaf, LogOut, UserRound, Users } from "lucide-react";
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="leading-tight">
            <p className="text-sm font-semibold tracking-[0.18em] text-[#6f8467] uppercase">
              ft_transcendence
            </p>
            <p className="text-xs text-[#7e8678]">
        ...
        <div className="flex items-center gap-2 rounded-full border border-[#ddd3c2] bg-[#fffaf2]/90 p-1.5 shadow-[0_8px_30px_rgba(90,107,86,0.08)]">
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-[#445046] transition hover:bg-[#eef3ea] hover:text-[#2f3a32]"
          >
