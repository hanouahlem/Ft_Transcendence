  ...
  return (
    ...
    >
      ...
      >
        <FieldInput
          type="text"
          label="Observer Designation / Username"
          placeholder="elara_vance"
          value={username}
        ...
        {success ? (
          <div
            className="border border-accent-green px-3 py-2 font-mono text-xs uppercase tracking-[0.08em] text-accent-green"
            style={{
              backgroundColor:
