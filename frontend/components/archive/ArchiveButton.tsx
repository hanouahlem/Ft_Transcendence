...
export const archiveButtonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-xl border text-center font-field-mono text-[11px] font-bold uppercase tracking-[0.18em] transition-all outline-none focus-visible:ring-4 focus-visible:ring-field-accent/20 active:translate-y-px disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ink: "border-field-ink bg-field-ink text-field-paper shadow-[2px_4px_0_#ff4a1c] hover:bg-field-ink/90",
        paper:
