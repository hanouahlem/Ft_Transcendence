    ...
    <section className="relative overflow-hidden border border-black/20 bg-[#285A35] px-6 py-8 text-[#F5F2EB] shadow-[15px_15px_30px_rgba(0,0,0,0.2)] sm:px-8 sm:py-10 lg:absolute lg:inset-y-10 lg:right-4 lg:left-[36%] lg:px-10 lg:py-10">
      ...
      <div className="relative z-10 flex h-full flex-col justify-between gap-10">
        <div className="ml-auto flex max-w-md flex-col items-end text-right lg:w-2/3">
          ...
          <h1 className="font-['Noto_Serif_SC'] text-[3.4rem] font-black uppercase leading-[0.82] tracking-[-0.05em] text-[#F5F2EB] mix-blend-overlay sm:text-[4.6rem]">
            Field
            <br />
            Notes
          </h1>
          ...
          <div className="mt-8 space-y-2 text-right">
            <MonoText className="block text-[10px] text-[#F5F2EB]/75">
              Official Repository
            </MonoText>
            <MonoText className="block text-[10px] text-[#F5F2EB]/75">
              Est. 1892
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1200px] items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
        <div className="relative flex w-full flex-col gap-6 lg:h-[700px] lg:justify-center">
          ...
          <AccentBeads className="absolute left-0 top-[20%] z-30 hidden translate-x-1/2 lg:flex" vertical />
      ...
      <AccentBeads className="fixed right-8 bottom-8 z-20 hidden rotate-45 md:flex" />
    </div>
  );
}
